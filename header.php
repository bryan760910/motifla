        ...
        <header class="header clearfix">
            ...
            <ul class="header_menu clearfix">
                <li class="header_menu_li">
                    <a href="/member.php" class="header_menu_item" data-name="ABOUT" data-zhname="公司簡介">ABOUT</a>
                </li>
                <li class="header_menu_li">
                    <a href="/showcase.php" class="header_menu_item" data-name="PROJECTS" data-zhname="案例實績">PROJECTS</a>
                </li>
                <li class="header_menu_li">
                    <a href="/concept.php" class="header_menu_item" data-name="CONCEPT" data-zhname="作品思想">CONCEPT</a>
                </li>
                <li class="header_menu_li" onmouseover="showlist(this)" onmouseout="hidelist(this)">
                    <a onmouseover="showlist(this)" onmouseout="hidelist(this)" href="javascript:;" class="header_menu_item" data-name="AWARDS"
                        data-zhname="獲獎資訊">AWARDS</a>
