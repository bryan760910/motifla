    ...
    <body>
        <div class="wrapper">
            ...
            <div class="profile_page clearfix inner_wrapper">
                <div class="leftside">
                    <img class ="left_content" src="/theme/images/concept.jpg" />
                </div>
                <div class="rightside">
                    <div class="right_content f_right">
                        <p>太研規劃設計顧問有限公司是專業的景觀規劃設計顧問公司，以Landscape Urbanism 的概念，反思傳統都市的設計操作，探討未來都市紋理與都市景觀及其附加構件之演變消長，並試圖找出未來景觀發展的契機及可能。
                        </p>
                        <p>Motif 主持人 吳書原 畢業於英國AA建築學院，為英國皇家景觀建築師協會副會員(ALI)、目前於文化大學環境設計學院建築系擔任助理教授，在London及Taipei已累積多年跨國之工作資歷，執業尺度包含都市、住宅開放空間及公園之規劃與設計，期許以在倫敦多年之經驗，豐富的國際視野為業主提供新的觀點及動力。
                        </p>
                    </div>
                </div>
            </div>
