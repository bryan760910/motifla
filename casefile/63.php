			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red"> 臺南育德路自宅 </span> <br />
						
                        <span class="left_content_desc_title">Location :</span> Tainan City, TW <br />
                        <span class="left_content_desc_title">Typology :</span> garden <br />
                        <span class="left_content_desc_title">Status :</span> 2019 complete <br />
                        
                        <br />
						<span class="left_content_desc_title ch">類型 :</span> 私人住宅 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2019 完工 <br />
                    </p>
				</div>
