			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title"></span> 2005 Participated <br /><br />
						<span class="left_content_desc_title">Location :</span> London <br />
						<span class="left_content_desc_title">Awards :</span> Street Design Award Winner <br />
						<span class="left_content_desc_title">Landscape Architect  :</span><br/> B U R N S + N I C E <br />
						<a style="word-break: break-all;" href="http://www.burnsnice.com/" target="_blank">http://www.burnsnice.com/</a>
					</p>
				</div>
				<div class="right_content">
					<div><img src="../theme/images/OLD_BAILEY_OPEN_SPACE/01.jpg" /></div>
					<div><img src="../theme/images/OLD_BAILEY_OPEN_SPACE/02.jpg" /></div>
					<div><img src="../theme/images/OLD_BAILEY_OPEN_SPACE/03.jpg" /></div>
				</div>
