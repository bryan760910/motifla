			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">Location :</span> Taipei City, Zhongshan Dist <br />
						<span class="left_content_desc_title">Size :</span> 3013 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">Categories :</span> Residential <br /><br />
						<span class="left_content_desc_title">基地位置 :</span> 臺北市 / 中山區 <br />
						<span class="left_content_desc_title">基地大小 :</span> 3013 m<sup>2</sup> <br />
						<span class="left_content_desc_title">空間性質 :</span> 集合住宅 
					</p>
				</div>
				<div class="right_content">
					<div><img src="../theme/images/Gitian_Development_Project_A/22_700X300_01.jpg" /></div>
					<div><img src="../theme/images/Gitian_Development_Project_A/22_700X300_02.jpg" /></div>
					<div><img src="../theme/images/Gitian_Development_Project_A/22_700X300_03.jpg" /></div>
					<div><img src="../theme/images/Gitian_Development_Project_A/22_700X300_04.jpg" /></div>
					<div><img src="../theme/images/Gitian_Development_Project_A/22_700X300_05.jpg" /></div>
					<div><img src="../theme/images/Gitian_Development_Project_A/22_700X300_06.jpg" /></div>
				</div>
