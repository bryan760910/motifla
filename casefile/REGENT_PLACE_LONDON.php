			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title"></span> 2009 Participated <br /><br />
						<span class="left_content_desc_title">Location :</span> London Triton Square  <br />
						<span class="left_content_desc_title">Awards :</span> Civic Trust Award Winner <br />
						<span class="left_content_desc_title">Landscape Architect  :</span> EDCO DESIGN <br />
						<a style="word-break: break-all;" href="http://www.edcodesign.net/" target="_blank">http://www.edcodesign.net/</a>
					</p>
				</div>
				<div class="right_content">
					<div><img src="../theme/images/REGENT_PLACE_LONDON/01.jpg" /></div>
					<div><img src="../theme/images/REGENT_PLACE_LONDON/02.jpg" /></div>
					<div><img src="../theme/images/REGENT_PLACE_LONDON/03.jpg" /></div>
					<div><img src="../theme/images/REGENT_PLACE_LONDON/04.jpg" /></div>
					<div><img src="../theme/images/REGENT_PLACE_LONDON/05.jpg" /></div>
				</div>
