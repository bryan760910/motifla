			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size  :</span> 5,420 M2 <br />
                        ...
                        <span class="left_content_desc_title ch">業主 :</span> 遠揚建設 <br />
						<span class="left_content_desc_title ch">類型 :</span> 集合住宅 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2013 - 執行中 <br />
                        <span class="left_content_desc_title ch">建築 :</span> 日建設計株式會社 <br />
                        <span class="left_content_desc_title ch" style="margin-left:34px;"></span> 大矩聯合建築事務所 <br /><br />
                    </p>
				</div>
				<div class="right_content">
                    <div><img src="/theme/images/19/1.jpg" /></div>
                    <div><img src="/theme/images/19/2.jpg" /></div>
				</div>
