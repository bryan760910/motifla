			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">L139  :</span> 新屋高中 <br />
						<span class="left_content_desc_title red">Taoyuan Xinwu High School│新屋高中</span><br />
						<span class="left_content_desc_title">Client :</span> XinWu Senior High School <br />
						<span class="left_content_desc_title">Location :</span> Taoyuan City, TW <br />
                        <span class="left_content_desc_title">Typology :</span> education <br />
                        <span class="left_content_desc_title">Status :</span> 2017 - present <br />
						<span class="left_content_desc_title">Size  :</span> 3.22 ha <br />
						<span class="left_content_desc_title">Architect  :</span> Joe Shih Architects <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 桃園市立新屋高級中等學校 <br />
						<span class="left_content_desc_title ch">類型 :</span> 校園 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2017 - 執行中 <br />
						<span class="left_content_desc_title ch">建築 :</span> 石昭永建築師事務所 <br /
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/49/1.jpg" /></div>
					<div><img src="/theme/images/49/2.jpg" /></div>
					<div><img src="/theme/images/49/3.jpg" /></div>
				</div>
