			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">Client :</span> TamKang Church <br />
						<a href="http://church.oursweb.net/" target="_blank">http://church.oursweb.net/</a><br />
						<span class="left_content_desc_title">Location :</span> Taiwan, New Taipei City <br />
						<span class="left_content_desc_title">Size :</span> 1830 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">Status :</span> Start 2013/ Work in progress <br />
						<span class="left_content_desc_title">Architect  :</span> Behet Bondzio Lin Architecten <br />
						<a href="http://www.2bxl.com/" target="_blank">http://www.2bxl.com/</a><br />
						<span class="left_content_desc_title">Categories :</span> Church Garden <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 基督教淡江教會<br/>
						<span class="left_content_desc_title ch">基地位置 :</span> 新北市 淡水區 <br />
						<span class="left_content_desc_title ch">基地大小 :</span> 1830 m<sup>2</sup>  <br />
						<span class="left_content_desc_title ch">進度 :</span> 2013 成案 / 進行中 <br />
						<span class="left_content_desc_title ch">建築師 :</span> 林友寒 <br />
						<span class="left_content_desc_title ch" style="margin-left:46px;"></span> 林彥穎<br />
						<span class="left_content_desc_title ch">空間性質 :</span> 教堂開放空間
					</p>
				</div>
