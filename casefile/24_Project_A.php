			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size :</span> 11170 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">Categories :</span> Residential <br /><br />
						
						<span class="left_content_desc_title">基地位置 :</span> 新北市 / 中和區 <br />
						<span class="left_content_desc_title">基地大小 :</span> 11170 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">空間性質 :</span> 集合住宅 <br /><br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="../theme/images/24_Project_A/1.jpg" /></div>
					<div><img src="../theme/images/24_Project_A/2.jpg" /></div>
					<div><img src="../theme/images/24_Project_A/3.jpg" /></div>
					<div><img src="../theme/images/24_Project_A/4.jpg" /></div>
				</div>
