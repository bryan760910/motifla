			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size  :</span> 2,250 M2 <br />
						...
						<span class="left_content_desc_title ch">建築 :</span> 2017 競圖首獎 <br />
						<span class="left_content_desc_title ch" style="margin-left:36px;"></span> competition winner <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/55/1.jpg" /></div>
				</div>
