			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red">Xingnan Section Condominium│王泰中和興南段 </span> <br />
						<span class="left_content_desc_title">Client :</span> Wangtai Land Development Group <br />
						<span class="left_content_desc_title">Location :</span> New Taipei City, Zhonghe Dist., TW <br />
                        <span class="left_content_desc_title">Typology :</span> residence <br />
                        <span class="left_content_desc_title">Status :</span>  2013 - 2018 <br />
						<span class="left_content_desc_title">Size  :</span> 2,965 M2 <br />
				...
				<div class="right_content">
                    <div><img src="/theme/images/24/1.jpg" /></div>
				</div>
