			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
                        ...
                        <span class="left_content_desc_title">Status :</span> 2016 - present <br />
						<span class="left_content_desc_title">Size  :</span> 650 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> DA-JU Architects&Associates <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 誠寬建設股份有限公司 <br />
						<span class="left_content_desc_title" style="margin-left:34px;"></span> 璞元建設股份有限公司 <br />
						<span class="left_content_desc_title ch">類型 :</span> 集合住宅 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2016 - 執行中 <br />
						<span class="left_content_desc_title ch">建築 :</span> 大矩聯合建築事務所 <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/30/1.jpg" /></div>
					<div><img src="/theme/images/30/2.jpg" /></div>
					<div><img src="/theme/images/30/3.jpg" /></div>
					<div><img src="/theme/images/30/4.jpg" /></div>
				</div>
