			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size  :</span> 10,703 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> Nikken Sekkei Ltd  <br />
						<span class="left_content_desc_title" style="margin-left:60px;"></span> DA-JU Architects & Associates  <br /><br />
						...
						<span class="left_content_desc_title ch">建築 :</span> 三門聯合建築師事務所 <br />
						<span class="left_content_desc_title ch" style="margin-left:36px;"></span> 大矩聯合建築事務所 <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/33/1.jpg" /></div>
				</div>
