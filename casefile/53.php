			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
                        ...
                        <span class="left_content_desc_title">Typology :</span> culture ‧ education <br />
                        <span class="left_content_desc_title">Status :</span> 2018 - present <br />
						<span class="left_content_desc_title">Size  :</span> 1.8 ha <br />
						<span class="left_content_desc_title">Architect  :</span> Joe Shih Architects <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 中央研究院 <br />
						<span class="left_content_desc_title ch">類型 :</span> 教育園區 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2018 - 執行中 <br />
						<span class="left_content_desc_title ch">建築 :</span> 石昭永建築師事務所 <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/53/1.jpg" /></div>
					<div><img src="/theme/images/53/2.jpg" /></div>
				</div>
