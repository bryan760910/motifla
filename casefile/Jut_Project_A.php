			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size :</span> 6266 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">Status :</span> Start 2014 / Work in progress <br />
						<span class="left_content_desc_title">Architect :</span> Norihiko Dan and Associates <br />
						<a href="www.dan-n.co.jp" target="_blank">www.dan-n.co.jp</a><br />
						<span class="left_content_desc_title">Local Architect :</span> LIAO Architects & Associates <br />
						<a href="http://liaoarch.wix.com/liaoarchitect" target="_blank">liaoarch.wix.com/liaoarchitect</a><br />
						...
						<span class="left_content_desc_title ch">基地大小 :</span> 6266 m<sup>2</sup>  <br />
						<span class="left_content_desc_title ch">進度 :</span> 2014 成案 / 進行中 <br />
						<span class="left_content_desc_title ch">建築師 :</span> 團紀彦建築設計事務所 <br />
						<span class="left_content_desc_title ch" style="margin-left:46px;"></span> 廖國誠建築師事務所<br />
