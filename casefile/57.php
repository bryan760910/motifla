			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
                        ...
                        <span class="left_content_desc_title">Typology :</span> master plan <br />
                        <span class="left_content_desc_title">Status :</span> 2018 proposal <br />
						<span class="left_content_desc_title">Size  :</span> 2 ha <br />
						<span class="left_content_desc_title">Architect  :</span> M‧H‧Wang Architects and Associate <br /><br />
						...
						<span class="left_content_desc_title ch">建築 :</span> 王銘顯建築師事務所 <br />

					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/57/1.jpg" /></div>
					<div><img src="/theme/images/57/2.jpg" /></div>
					<div><img src="/theme/images/57/3.jpg" /></div>
					<div><img src="/theme/images/57/4.jpg" /></div>
				</div>
