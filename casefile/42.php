			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">L023  :</span> 淡江教會 <br />
						<span class="left_content_desc_title red">Tamkang Church Landscape Design│淡江教會 </span><br />
                        ...
                        <span class="left_content_desc_title">Status :</span> 2013 - built <br />
						<span class="left_content_desc_title">Size  :</span> 1,830 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> behet bondzio lin architects GmbH & Co. KG <br />
						<span class="left_content_desc_title ch" style="margin-left:62px;"></span>Yen Partnership Architects <br /><br />

						<span class="left_content_desc_title ch">業主 :</span> 淡江教會 <br />
						<span class="left_content_desc_title ch">類型 :</span> 教會開放空間 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2013 - 建造中 <br />
						<span class="left_content_desc_title ch">建築 :</span> 清水建築工坊 <br />
						<span class="left_content_desc_title ch" style="margin-left:36px;"></span>林彥穎建築師事務所 <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/42/1.jpg" /></div>
					<div><img src="/theme/images/42/2.jpg" /></div>
					<div><img src="/theme/images/42/3.jpg" /></div>
				</div>
