			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red">Jut Land Project A│忠泰建設大稻埕集合住宅 </span> <br />
						...
						<span class="left_content_desc_title">Size  :</span> 8,154 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> Norihiko Dan and Associates <br />
                        <span class="left_content_desc_title ch" style="margin-left:63px;"></span> Liao Architects & Associates <br />
                        <br />
						...
						<span class="left_content_desc_title ch">建築 :</span> 團紀彦建築設計事務所 <br />
                        <span class="left_content_desc_title ch" style="margin-left:34px;"></span> 廖國誠建築師事務所 <br />
                    </p>
				</div>
				<div class="right_content">
                    <div><img src="/theme/images/22/1.jpg" /></div>
                    <div><img src="/theme/images/22/2.jpg" /></div>
                    <div><img src="/theme/images/22/3.jpg" /></div>
                    <div><img src="/theme/images/22/4.jpg" /></div>
				</div>
