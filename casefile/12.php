			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red"> London Chelsea Barrack </span> <br />
						<span class="left_content_desc_title">Location :</span> London <br />
                        <span class="left_content_desc_title">Typology :</span>  residence <br />
                        <span class="left_content_desc_title">Architect :</span> Rogers Stirk Harbour+Partners <br />
				...
				<div class="right_content">
                    <div><img src="../theme/images/12/1.jpg" /></div>
                    <div><img src="../theme/images/12/2.jpg" /></div>
                    <div><img src="../theme/images/12/3.jpg" /></div>
                    <div><img src="../theme/images/12/4.jpg" /></div>
				</div>
