			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">L161  :</span> 大尺淡水建案 <br />
						<span class="left_content_desc_title red">Tamsui Project│麗源建設  </span> <br />
						<span class="left_content_desc_title">Client :</span> Lih-Yuan Construction Company <br />
						...
						<span class="left_content_desc_title">Size  :</span> 6,353.05 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> Hsuyuan Kao Architects & Associates <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 麗源建設股份有限公司 <br />
				...
				<div class="right_content">
					<div><img src="/theme/images/34/1.jpg" /></div>
				</div>
