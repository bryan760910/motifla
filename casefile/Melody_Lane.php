			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title"></span> 2004 Participated <br /><br />
						<span class="left_content_desc_title">Location :</span> London  <br />
						<span class="left_content_desc_title">Awards :</span> Small Housebuilder Winner <br />
						<span class="left_content_desc_title">Landscape Architect :</span><br /> B U R N S + N I C E <br />
						<a style="word-break: break-all;" href="http://www.burnsnice.com/" target="_blank">http://www.burnsnice.com/</a><br />
						<span class="left_content_desc_title">Architect :</span> Julian Cowie Architects<br />
						<a style="word-break: break-all;" href="http://jc-architects.co.uk/" target="_blank">http://jc-architects.co.uk/</a><br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/Melody_Lane/1.jpg" /></div>
					<div><img src="/theme/images/Melody_Lane/2.jpg" /></div>
					<div><img src="/theme/images/Melody_Lane/3.jpg" /></div>
					<div><img src="/theme/images/Melody_Lane/4.jpg" /></div>
					<div><img src="/theme/images/Melody_Lane/5.jpg" /></div>
					<div><img src="/theme/images/Melody_Lane/6.jpg" /></div>
				</div>
