			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Location :</span> Taiwan, New Taipei City, Luzhou Dist <br />
						<span class="left_content_desc_title">Size :</span> 32 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">Status :</span> Start 2014 / Completed in 2014 <br />
						<span class="left_content_desc_title">Categories :</span> Private Terrace  <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span>  璞園建築 <br />
						<span class="left_content_desc_title ch">基地位置 :</span> 新北市 蘆洲區 <br />
						<span class="left_content_desc_title ch">基地大小 :</span> 32 m<sup>2</sup>  <br />
						<span class="left_content_desc_title ch">進度 :</span> 2014 成案 / 2014 完工 <br />
						<span class="left_content_desc_title ch">空間性質 :</span> 私人露臺
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/Pauian_03/01.jpg" /></div>
					<div><img src="/theme/images/Pauian_03/02.jpg" /></div>
					<div><img src="/theme/images/Pauian_03/03.jpg" /></div>
				</div>
