			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">Client :</span> Lungyen Group <br />
						<span class="left_content_desc_title">Location :</span> Taiwan ,New Taipei City ,Xizhi Dist <br />
						<span class="left_content_desc_title">Size :</span> 3969 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">Status :</span> Start 2013 / Completed in 2015 <br />
						<span class="left_content_desc_title">Local Architect :</span> TOPLAN Consultant Inc. <br />
						<a href="http://www.tpco.com" target="_blank">http://www.tpco.com</a><br />
						<span class="left_content_desc_title">Categories :</span> Office  <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span>  Lungyen 集團 <br />
						<span class="left_content_desc_title ch">基地位置 :</span> 新北市 汐止區 <br />
						<span class="left_content_desc_title ch">基地大小 :</span> 3969 m<sup>2</sup>  <br />
						<span class="left_content_desc_title ch">進度 :</span> 2013成案 / 2015 完工 <br />
						<span class="left_content_desc_title ch">建築師 :</span> 羅中燡 <br />
						<span class="left_content_desc_title ch">空間性質 :</span> 企業總部  <br />
					</p>
				</div>
