			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size  :</span> 1.9 ha <br />
						<span class="left_content_desc_title">Architect  :</span> Dai Xiaoqin Architects <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 臺南市政府 <br />
						<span class="left_content_desc_title ch">類型 :</span> 考古文化園區 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2017 - 執行中 <br />
						<span class="left_content_desc_title ch">建築 :</span> 戴小芹建築師事務所 <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/50/1.jpg" /></div>
					<div><img src="/theme/images/50/2.jpg" /></div>
					<div><img src="/theme/images/50/3.jpg" /></div>
					<div><img src="/theme/images/50/4.jpg" /></div>
					<div><img src="/theme/images/50/5.jpg" /></div>
				</div>
