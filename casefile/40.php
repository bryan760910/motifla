			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size  :</span> 5,207.76 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> behet bondzio lin architects GmbH & Co. KG <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 順天建設股份有限公司 <br />
				...
				<div class="right_content">
					<div><img src="/theme/images/40/1.jpg" /></div>
				</div>
