			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">L128  :</span> 旗山糖廠 <br />
						<span class="left_content_desc_title red">Cishan Sugar Refinery│旗山糖廠</span><br />
						<span class="left_content_desc_title">Client :</span> Kaohsiung City Government <br />
						<span class="left_content_desc_title">Location :</span> Kaohsiung City, TW <br />
                        <span class="left_content_desc_title">Typology :</span> culture ‧ master plan <br />
                        <span class="left_content_desc_title">Status :</span> 2017 - present <br />
						<span class="left_content_desc_title">Size  :</span> 15.9 ha <br />
						<span class="left_content_desc_title">Architect  :</span> C.C.HSU ARCHITECTS & ASSOCIATES <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 高雄市政府 <br />
						<span class="left_content_desc_title ch">類型 :</span> 歷史文化園區 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2017 - 執行中 <br />
						<span class="left_content_desc_title ch">建築 :</span> 許家彰建築師事務所 <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/48/1.jpg" /></div>
					<div><img src="/theme/images/48/2.jpg" /></div>
					<div><img src="/theme/images/48/3.jpg" /></div>
					<div><img src="/theme/images/48/4.jpg" /></div>
					<div><img src="/theme/images/48/5.jpg" /></div>
				</div>
