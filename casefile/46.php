			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title" style="margin-left:60px;"></span> Yen Partnership Architects <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 新竹市政府 <br />
						<span class="left_content_desc_title ch">類型 :</span> 生命園區 <br />
				...
				<div class="right_content">
					<div><img src="/theme/images/46/1.jpg" /></div>
					<div><img src="/theme/images/46/2.jpg" /></div>
					<div><img src="/theme/images/46/3.jpg" /></div>
					<div><img src="/theme/images/46/4.jpg" /></div>
				</div>
