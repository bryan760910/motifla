			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">L096  :</span> 信義區三興段公益住宅 <br />
						<span class="left_content_desc_title red">San-Xing Sec. Social Housing│三興段公共住宅</span><br />
                        ...
                        <span class="left_content_desc_title">Status :</span> 2015 - built <br />
						<span class="left_content_desc_title">Size  :</span> 1.1 ha <br />
						<span class="left_content_desc_title">Architect  :</span> Hsuyuan Kao Architects & Associates <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 臺北市政府 <br />
						...
						<span class="left_content_desc_title ch">建築 :</span> 2015 競圖首獎 <br />
						<span class="left_content_desc_title ch" style="margin-left:36px;"></span> competition winner <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/54/1.jpg" /></div>
					<div><img src="/theme/images/54/2.jpg" /></div>
					<div><img src="/theme/images/54/3.jpg" /></div>
					<div><img src="/theme/images/54/4.jpg" /></div>
					<div><img src="/theme/images/54/5.jpg" /></div>
					<div><img src="/theme/images/54/6.jpg" /></div>
				</div>
