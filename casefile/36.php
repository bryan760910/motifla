			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">L175  :</span> 明緯八里大崁段 <br />
						<span class="left_content_desc_title red">Bali Project│明緯建設 </span> <br />
						<span class="left_content_desc_title">Client :</span> Mean Way Constructional Co., Ltd. <br />
						...
						<span class="left_content_desc_title">Size  :</span> 0.1 ha <br />
						<span class="left_content_desc_title">Architect  :</span> Zhaojia Li  Architects <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 明緯建設股份有限公司 <br />
						<span class="left_content_desc_title ch">類型 :</span> 集合住宅 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2018 - 執行中 <br />
						<span class="left_content_desc_title ch">建築 :</span> 李兆嘉建築師事務所 <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/36/1.jpg" /></div>
				</div>
