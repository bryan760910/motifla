			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red">Bo'ai Street Condominium│久泰永和博愛街 </span> <br />
						<span class="left_content_desc_title">Client :</span> Gautai Land Development Group <br />
						<span class="left_content_desc_title">Location :</span> New Taipei City, Yonghe Dist., TW <br />
                        <span class="left_content_desc_title">Typology :</span> residence <br />
                        <span class="left_content_desc_title">Status :</span>  2013 - present <br />
						<span class="left_content_desc_title">Size  :</span> 3,165 M2 <br />
						...
						<span class="left_content_desc_title ch">進度 :</span> 2013 - 執行中 <br />
				...
				<div class="right_content">
                    <div><img src="/theme/images/23/1.jpg" /></div>
                    <div><img src="/theme/images/23/2.jpg" /></div>
				</div>
