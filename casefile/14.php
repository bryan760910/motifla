			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red">Lungyen Group Headquarter </span> <br />
                        ...
                        <span class="left_content_desc_title">Typology :</span> headquarter <br />
                        <span class="left_content_desc_title">Status :</span> 2013 - 2015 <br />
						<span class="left_content_desc_title">Size  :</span> 3,969 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> TOPLAN Consultant Inc. <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 龍巖集團 <br />
						<span class="left_content_desc_title ch">類型 :</span> 企業總部 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2013 - 2015 <br />
						<span class="left_content_desc_title ch">建築 :</span> 羅中燡建築事務所 <br />
                    </p>
				</div>
