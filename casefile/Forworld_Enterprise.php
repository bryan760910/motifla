			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size :</span> 4476 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">Status :</span> Start 2014/ Work in progress <br />
						<span class="left_content_desc_title">Local Architect  :</span> Tsai Architects <br />
						...
						<span class="left_content_desc_title ch">基地大小 :</span> 4476 m<sup>2</sup>  <br />
						<span class="left_content_desc_title ch">進度 :</span> 2014 成案 / 進行中 <br />
						<span class="left_content_desc_title ch">建築師 :</span> 蔡智勸建築師事務所 <br />
