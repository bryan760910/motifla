			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red">Andante Cantabile│宏濟心樂章 </span> <br />
						<span class="left_content_desc_title">Client :</span> Hongji <br />
						<span class="left_content_desc_title">Location :</span> Xindian Dist., New Taipei City <br />
                        <span class="left_content_desc_title">Typology :</span> culture ‧ healthcare <br />
                        <span class="left_content_desc_title">Status :</span> 2017 - 2018 <br />
						<span class="left_content_desc_title">Size  :</span> 775 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> Wooyo <br />
                        <span class="left_content_desc_title">Construction  :</span> Yusheng International Landscape <br />
                        <br />
						
                        <span class="left_content_desc_title ch">業主 :</span> 怡濟慈園醫療社團法人宏濟神經精神科醫院局  <br />
						<span class="left_content_desc_title ch">類型 :</span> 精神科醫院開放空間設計 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2017 - 2018 <br />
                        <span class="left_content_desc_title ch">建築 :</span> 無有設計 <br />
                        <span class="left_content_desc_title ch">施工 :</span> 昱盛國際景觀有限公司 <br />
                    </p>
				</div>
				<div class="right_content">
                    <div><img src="/theme/images/2/1.jpg" /></div>
                    <div><img src="/theme/images/2/2-1.jpg" /></div>
                    <div><img src="/theme/images/2/2-2.jpg" /></div>
                    <div><img src="/theme/images/2/3.jpg" /></div>
                    <div><img src="/theme/images/2/4.jpg" /></div>
                    <div><img src="/theme/images/2/5.jpg" /></div>
				</div>
