			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size  :</span> 0.3 ha <br />
                        <span class="left_content_desc_title">Architect  :</span> Wensheng Li Architects <br />
                        <span class="left_content_desc_title ch" style="margin-left:64px;"></span> Full Idea Design Ltd. <br />
                        
                        <br />
                        <span class="left_content_desc_title ch">業主 :</span> 達麗建設事業 <br />
                        <span class="left_content_desc_title ch">類型 :</span> 集合住宅 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2018 - 執行中 <br />
						<span class="left_content_desc_title ch">建築 :</span> 李文勝建築師事務所  <br />
                        <span class="left_content_desc_title ch" style="margin-left:34px;"></span> 富翊設計有限公司 <br />
                    </p>
				</div>
				<div class="right_content">
                    <div><img src="/theme/images/64/1.jpg" /></div>
                    <div><img src="/theme/images/64/2.jpg" /></div>
				</div>
