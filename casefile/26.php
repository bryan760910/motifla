			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red">Taipei Tower│富邦建設 </span> <br />
                        ...
                        <span class="left_content_desc_title">Status :</span>  2014 - present <br />
						<span class="left_content_desc_title">Size  :</span> 5,184 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> Rogers Stirk Harbour <br />
                        <span class="left_content_desc_title ch" style="margin-left:63px;"></span> + Partners <br />
                        <span class="left_content_desc_title ch" style="margin-left:63px;"></span> DA-JU Architects <br />
						...
						<span class="left_content_desc_title ch">建築 :</span> Rogers Stirk Harbour + Partners <br />
                        <span class="left_content_desc_title ch" style="margin-left:34px;"></span> 大矩聯合建築事務所 <br />
                    </p>
				</div>
				<div class="right_content">
                    <div><img src="../theme/images/26/1.jpg" /></div>
                    <div><img src="../theme/images/26/2.jpg" /></div>
				</div>
