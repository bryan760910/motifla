			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size  :</span> 285 M2 <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 璞石興業股份有限公司 <br />
						<span class="left_content_desc_title ch">類型 :</span> 庭園 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2018 - 執行中 <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/37/1.jpg" /></div>
				</div>
