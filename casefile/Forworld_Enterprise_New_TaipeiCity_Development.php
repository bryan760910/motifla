			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">Client :</span> Forworld  Enterprisep <br />
						<a href="http://www.fwd.tw/" target="_blank">http://www.fwd.tw/</a><br />
						<span class="left_content_desc_title">Location :</span> Taiwan, New Taipei City <br />
						<span class="left_content_desc_title">Size :</span> 9200 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">Status :</span> Start 2014 / Work in progress <br />
						<span class="left_content_desc_title">Local Architect  :</span><br /> AOE ARCHITECT & ASSOCIATES <br />
						<span class="left_content_desc_title">Categories :</span> Mixed Use <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 馥華集團 <br />
						<span class="left_content_desc_title ch">基地位置 :</span> 臺北市 中和區 <br />
						<span class="left_content_desc_title ch">基地大小 :</span> 9200 m<sup>2</sup>  <br />
						<span class="left_content_desc_title ch">進度 :</span> 2014 成案 / 進行中 <br />
						<span class="left_content_desc_title ch">建築師 :</span> 奧宇國際設計集團 <br />
