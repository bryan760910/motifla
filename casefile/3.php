			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red">西區門戶│三井廣場 </span> <br />
						<span class="left_content_desc_title">Client :</span> Department of Cultural Affairs <br />
						<span class="left_content_desc_title ch" style="margin-left:45px;"></span> Park and Street Lights Office <br />
                        <span class="left_content_desc_title ch" style="margin-left:45px;"></span> Taipei City Government <br />
						...
						<span class="left_content_desc_title">Size  :</span> 0.9 ha <br />
                        <br />
