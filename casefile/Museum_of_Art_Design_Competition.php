			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Size :</span> 25000 m<sup>2</sup><br />
						<span class="left_content_desc_title">Awards :</span> 4th <br />
						<span class="left_content_desc_title">Architect :</span> Norihiko Dan and Associates <br />
						<a href="http://www.dan-n.co.jp/" target="_blank">http://www.dan-n.co.jp/</a><br />
						<span class="left_content_desc_title">Local Architect :</span>  Su Mao-Pin Architect <br /><br />
						
						<span class="left_content_desc_title ch">基地位置 :</span> 新北市 鶯歌區 <br />
						<span class="left_content_desc_title ch">基地大小 :</span> 25000 m<sup>2</sup>  <br />
						<span class="left_content_desc_title ch">競圖名次 :</span> 第四名 <br />
						<span class="left_content_desc_title ch">建築團隊 :</span> 團紀彥建築設計事務所 <br />
						<span class="left_content_desc_title ch" style="margin-left:58px;"></span> 蘇懋彬建築師事務所<br />
					</p>
				</div>
