			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title red">Qingpu Project B│璞園建築 </span> <br />
						...
						<span class="left_content_desc_title">Size  :</span> 3,147 M2 <br />
						<span class="left_content_desc_title">Architect  :</span> Akihisa Hirata Architecture <br />
                        <span class="left_content_desc_title ch" style="margin-left:63px;"></span> Chengyu Architect <br />
						...
						<span class="left_content_desc_title ch">建築 :</span> 平田晃久 <br />
                        <span class="left_content_desc_title ch" style="margin-left:34px;"></span> 昌瑜建築事務所 <br />
                    </p>
				</div>
				<div class="right_content">
                    <div><img src="../theme/images/21/1.jpg" /></div>
                    <div><img src="../theme/images/21/2.jpg" /></div>
                    <div><img src="../theme/images/21/3.jpg" /></div>
				</div>
