			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						...
						<span class="left_content_desc_title">Location :</span> Taiwan, Taoyuan City, Zhongli Dist<br />
						<span class="left_content_desc_title">Size :</span> 3147 m<sup>2</sup>  <br />
						<span class="left_content_desc_title">Status :</span> Start 2013 / Work in progress <br />
						<span class="left_content_desc_title">Local Architect  :</span> Akihisa Hirata <br />
						<a href="http://www.hao.nu/" target="_blank">http://www.hao.nu/</a><br />
						...
						<span class="left_content_desc_title ch">基地大小 :</span> 3147 m2<br />
						<span class="left_content_desc_title ch">進度 :</span> 2013成案 / 進行中<br />
						<span class="left_content_desc_title ch">建築師 :</span> 平田晃久<br />
						<span class="left_content_desc_title ch" style="margin-left:46px;"></span> 昌瑜建築師事務所<br />
