			...
			<div class="detail_page clearfix inner_wrapper">
				...
				<div class="left_content">
					...
					<p class="left_content_desc">
						<span class="left_content_desc_title">L194  :</span> 桃園美術館 <br />
						<span class="left_content_desc_title red">Taoyuan City Museum of Modern Art│桃園市立美術館</span><br />
                        ...
                        <span class="left_content_desc_title">Typology :</span> museum <br />
                        <span class="left_content_desc_title">Status :</span> 2018 participated - present <br />
						<span class="left_content_desc_title">Size  :</span> 9.8 ha <br />
						<span class="left_content_desc_title">Architect  :</span> Joe Shih Architects <br /><br />
						
						<span class="left_content_desc_title ch">業主 :</span> 桃園市政府 <br />
						<span class="left_content_desc_title ch">類型 :</span> 美術館 <br />
						<span class="left_content_desc_title ch">進度 :</span> 2018 - 執行中 <br />
						<span class="left_content_desc_title ch">建築 :</span> 石昭永建築師事務所 <br />
					</p>
				</div>
				<div class="right_content">
					<div><img src="/theme/images/52/1.jpg" /></div>
				</div>
