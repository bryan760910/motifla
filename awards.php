    ...
    <body>
        ...
        <div class="wrapper">
            ...
            <div class="publications_page clearfix inner_wrapper">
                <div class="leftside">
                    <img class ="left_content" src="theme/images/awards.jpg" />
                ...
                <div class="rightside clearfix" id="award">
                    <div class="right_content f_right">
                        ...
                        <p>新北市立美術館國際競圖 第四名</p><br /> 
                        <p>2015</p>
                        <p>臺北市信義區三興段公共住宅競圖 首獎</p>
                        <p>臺南亞太國際棒球場競圖 第二名</p><br /> 
                        <p>2016</p>
                        <p>臺南水交社文化園區競圖 首獎</p>
                        <p>臺南左鎮菜寮化石文化園區競圖 首獎</p>
                        <p>新竹市大坪頂納骨塔新建工程景觀設計競圖 首獎</p>
                        <p>捷運中山雙連段帶狀公園改造工程規劃設計案競圖 第三名</p>
                        <p>臺南市赤崁文化園區競圖 第五名</p><br /> 
                        <p>2017</p>
                        <p>臺中市北屯區同榮段社會住宅景觀設計競圖 首獎</p>
                        <p>臺北市文山區興隆段社會住宅景觀設計競圖 首獎</p>
                        <p>臺南市流浪動物之家景觀設計競圖 第二名</p>
                        <p>臺南市九份子市地重劃區新設國民小學景觀設計競圖 第二名</p>
                        <p>臺中世界花卉博覽會園區標誌系統設計競圖 首獎</p>
